...
<form action="index.php?content=about" method="post" name="maint" id="maint">
    ...
    <li><label for="position">Position</label><br />
        ...
        value="<?php echo htmlspecialchars($item->getPosition()); ?>" />
      </li>
      ...
      <li>
        ...
        <input type="text" name="user_name" id="user_name" value="<?php echo htmlspecialchars($item->getUser_name()); ?>" />
      </li>
      <li>
