    ...
    function deleteContact() {
      ...
      if (isset($_POST['delete']) AND $_POST['delete'] == 'Delete') {
          ...
          || $_POST['token'] !== $_SESSION['token'])
        {
          ...
          $badToken = false;
          unset($_SESSION['token']);
          //Delete the Contact fromthe table
      ...
      if (isset($_POST['save']) AND $_POST['save'] == 'Save') {
          ...
          || $_POST['token'] !== $_SESSION['token'])
        {
          ...
          $item = array (
            ...
            'lot_name' => filter_input(INPUT_POST,'lot_name', FILTER_SANITIZE_STRING,FILTER_FLAG_NO_ENCODE_QUOTES),
            'lot_description' => filter_input(INPUT_POST,'lot_description', FILTER_SANITIZE_STRING,FILTER_FLAG_NO_ENCODE_QUOTES),
            'lot_image' => filter_input(INPUT_POST,'lot_image', FILTER_SANITIZE_STRING),
            'lot_number' => (int) $_POST['lot_number'],
            'lot_price' => filter_input(INPUT_POST,'lot_price', FILTER_SANITIZE_NUMBER_FLOAT,FILTER_FLAG_ALLOW_FRACTION),
            'cat_id' => (int) $_POST['cat_id']
            );
   ...
   function deleteLot() {
    ...
    if (isset($_POST['delete']) AND $_POST['delete'] == 'Delete') {
      ...
      if (!isset($_POST['token'])
        ...
        || $_POST['token'] !== $_SESSION['token']) 
      {
        $results = array(' ','Sor , go back and try again.
